...
public function loadBySlug($locationSlug){
			...
			//2 create query
			$sSql = "SELECT locationID, slug, ClaimStatus, locationName, locationAddress, locationSuburb, locationRegion, locationContact, locationWebsite, locationInfo, locationEvents FROM `location` WHERE slug ='$locationSlug'";
