...
class Beer{
	...
	public function load($iBeerID){
		...
		//2 create query
		$sSql = "SELECT  BeerID,  Title,  Description, StyleID, BreweryID, Brewery, BreweryName, Alcohol, Active, Exclusive, Photo FROM  beer WHERE  BeerID =".$iBeerID;
...
// 		$this->sNewLocation = $aRow["NewLocation"];
	...
	public function save(){
		...
		$sSql = "INSERT INTO beer (Title, Description, StyleID, NewStyle, BreweryID, Brewery, BreweryName, Alcohol, Active, NewLocation, Photo) 
