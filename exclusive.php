			...
			<div id="searchResults">
					...
					<div class="wrapper clearfix">
						...
						<?php	$totalTaps = Availability::totalTaps();
							...
							echo '<p><a class="btn btn-default" href="viewlocations.php">View '.count($totalLoc).' Locations</a> <a class="btn btn-default" href="brews.php">View '.$totalTaps.' taps </a> </p>'; ?>
