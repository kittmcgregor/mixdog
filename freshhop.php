			...
			<div id="searchResults">
					...
					<div class="wrapper clearfix">
						...
						<?php	$totalTaps = Availability::totalTaps();
							...
							echo '<p><a class="btn btn-default" href="brews.php">'.$totalTaps.' taps </a> <a class="btn btn-default" href="viewbreweries.php">'.count(Brewery::all()).' Breweries </a> <a class="btn btn-default" href="viewlocations.php">'.count($totalLoc).' Locations</a></p>'; ?>
...
*/
							...
							echo '<h4>Fresh Hop Brews</h4>';
							$iBeersPerPage = 20;
							$currentpage = "brews";
							//echo View::renderAllBeers($oAllBeers,$loggedin,$userID,$iBeersPerPage,$currentpage);
							echo '<ul id="listings">';
							echo View::renderFreshHopBeers($aFreshHop,$iBeersPerPage,1,$domain);
							echo '<ul id="listings">';
